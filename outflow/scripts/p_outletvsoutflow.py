...
ax.plot(data1[1].to_numpy(), data1[0].to_numpy(), label=r'Coarse Outflow ')
ax.plot(data2[1].to_numpy(), data2[0].to_numpy(), label=r'Moderate Outflow')
ax.plot(data3[1].to_numpy(), data3[0].to_numpy(), label=r'Fine Outflow')
ax.plot(data4[1].to_numpy(), data4[0].to_numpy(), label=r'Coarse Pressure outlet')
ax.plot(data5[1].to_numpy(), data5[0].to_numpy(), label=r'Moderate Pressure outlet')
ax.plot(data6[1].to_numpy(), data6[0].to_numpy(), label=r'Fine Pressure outlet')
