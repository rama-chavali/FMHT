    ...
    YMAX = 101 % NUMBER OF GRID POINTS
...
for J = 1:YMAX
    ...
    x1=DATA1{:,1}
    y1=DATA1{:,2}
    plot(x1,y1,'DisplayName','moderate')
    legend show;
    hold on 
    ...
    x2=DATA2{:,1}
    y2=DATA2{:,2}
    plot(x2,y2,'DisplayName','coarse')
    legend show;
    hold on
    DATA3=readtable("2m_geometry_400x40\outlet.txt")
    x3=DATA3{:,1}
    y3=DATA3{:,2}
    plot(x3,y3,'DisplayName','fine')
    legend show;
    hold on
    DATA4=readtable("2m_geometry_400x40\outletfine.txt")
    x4=DATA4{:,1}
    y4=DATA4{:,2}
    plot(x4,y4,'DisplayName','finer')
    legend show;
    hold on
    plot(Y',U','DisplayName','analytical')
    legend show;
	hold off
    grid on 
